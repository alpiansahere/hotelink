...
document.getElementById("quizForm").addEventListener("submit", function (e) {
    ...
    if (konfirmasi) {
        ...
        // Di sini bisa ditambahkan logika untuk mengirim data ke server jika diperlukan.
    } else {
    ...
    questions.forEach((q, index) => {
        ...
        const userAnswerText = q.options[userAnswerKey]; // Mengambil teks jawaban pengguna
    ...
    // **Sembunyikan soal setelah submit**
